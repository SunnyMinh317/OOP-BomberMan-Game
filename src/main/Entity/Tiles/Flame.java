...
public class Flame extends Tile {
    ...
    private BufferedImage[] flameTexture = new BufferedImage[7];
    ...
    public Flame(int x, int y, boolean isEnd, int direction) {
        ...
        if (!isEnd) {
            if (direction == 0) {
                ...
                flameTexture[4] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 2, Game.TILESHEET_BLOCK_SIZE * 12, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[5] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 7, Game.TILESHEET_BLOCK_SIZE * 7, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[6] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 2, Game.TILESHEET_BLOCK_SIZE * 7, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
            } else if (direction == 1) {
                ...
                flameTexture[4] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 3, Game.TILESHEET_BLOCK_SIZE * 11, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[5] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 8, Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[6] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 3, Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
            } else if (direction == 2) {
                ...
                flameTexture[4] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 2, Game.TILESHEET_BLOCK_SIZE * 10, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[5] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 7, Game.TILESHEET_BLOCK_SIZE * 5, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[6] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 2, Game.TILESHEET_BLOCK_SIZE * 5, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
            } else if (direction == 3) {
                ...
                flameTexture[4] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 1, Game.TILESHEET_BLOCK_SIZE * 11, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[5] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[6] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 1, Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
            }
        } else {
            if (direction == 0) {
                ...
                flameTexture[4] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 2, Game.TILESHEET_BLOCK_SIZE * 13, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[5] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 7, Game.TILESHEET_BLOCK_SIZE * 8, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[6] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 2, Game.TILESHEET_BLOCK_SIZE * 8, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
            } else if (direction == 1) {
                ...
                flameTexture[4] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 4, Game.TILESHEET_BLOCK_SIZE * 11, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[5] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 9, Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[6] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 4, Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
            } else if (direction == 2) {
                ...
                flameTexture[4] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 2, Game.TILESHEET_BLOCK_SIZE * 9, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[5] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 7, Game.TILESHEET_BLOCK_SIZE * 4, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[6] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 2, Game.TILESHEET_BLOCK_SIZE * 4, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
            } else if (direction == 3) {
                ...
                flameTexture[4] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 0, Game.TILESHEET_BLOCK_SIZE * 11, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[5] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 5, Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
                flameTexture[6] = Game.gameTileSheet.getSubimage(Game.TILESHEET_BLOCK_SIZE * 0, Game.TILESHEET_BLOCK_SIZE * 6, Game.TILESHEET_BLOCK_SIZE, Game.TILESHEET_BLOCK_SIZE);
            }
        }
    }
